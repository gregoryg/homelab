...
** In Harvester, create our cluster node VMs
   ...
   | vzdev-1 | 3m5s | Running |  172.16.17.78 | pandora       |
   | vzdev-2 | 46m  | Running | 172.16.17.159 | protomolecule |
   | vzdev-3 | 46m  | Running | 172.16.17.176 | protomolecule |
   | vzdev-4 | 48m  | Running | 172.16.17.132 | pandora       |
   | vzdev-5 | 57m  | Running |  172.16.17.41 | pandora       |
   | vzdev-6 | 46m  | Running |  172.16.17.65 | protomolecule |
   | vzdev-7 | 115s | Running | 172.16.17.105 | pandora       |
   | vzdev-8 | 46m  | Running |  172.16.17.60 | protomolecule |
