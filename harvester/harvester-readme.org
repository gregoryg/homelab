...
* The "official" node driver
  #+begin_src bash
    docker-machine create -d harvester-harvester \
...
** In Harvester, create our cluster node VMs
           ...
           spec:
             pvc:
               ...
               resources:
                 requests:
                   storage: 10Gi
               storageClassName: longhorn-image-d4z5p
               volumeMode: Block
             source:
               blank: {}
         template:
   ...
   #+begin_src bash  :results none :async yes :noweb yes
...
** Open bastion container shell
   ...
   + copy the node files to the bastion
     #+begin_src emacs-lisp :results none
       (copy-file "/tmp/all-nodes.txt" "/kube:default@mysh:/home/gregj/" t)
       (copy-file "/tmp/master-nodes.txt" "/kube:default@mysh:/home/gregj/" t)
       (copy-file "/tmp/worker-nodes.txt" "/kube:default@mysh:/home/gregj/" t)
     #+end_src
