...
** Post query processing
   ...
   #+name: dbnamespace
   #+begin_src emacs-lisp   :dir /kube:stardog-stardog-0:/var/opt/stardog :var db="starwars"
     ...
     (setq dbnamespace
           (mapcar
            ...
            (mapcar
             ...
             (s-split "\n"
                      (s-trim
                       (shell-command-to-string (concat "/opt/stardog/bin/stardog namespace list " db " | tail -n +4 |head -n -1|tr -d ' '|cut -d'|' -f2,3 --output-delimiter=,")))))))
     ;; )
   #+end_src
