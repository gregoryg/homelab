...
*** Load data
    #+begin_src sql :tangle solutions/supplychain/02-load-data.gsql
      ...
      DEFINE FILENAME Model_Number_Only="m1:/home/tigergraph/tigergraph/data/mydata/supplychain/Model Number Only.csv";
      DEFINE FILENAME ModelItemNumber="m1:/home/tigergraph/tigergraph/data/mydata/supplychain/ModelItemNumber.csv";
      DEFINE FILENAME Inventory="m1:/home/tigergraph/tigergraph/data/mydata/supplychain/Inventory.csv";
      DEFINE FILENAME BuildSchedule_July="m1:/home/tigergraph/tigergraph/data/mydata/supplychain/BuildSchedule July 21.csv";
      DEFINE FILENAME ItemMaster="m1:/home/tigergraph/tigergraph/data/mydata/supplychain/ItemMaster POC.csv";
      DEFINE FILENAME BOM="m1:/home/tigergraph/tigergraph/data/mydata/supplychain/BOM with Unique Identifier.csv";
      DEFINE FILENAME demandtopartusedby="m1:/home/tigergraph/tigergraph/data/mydata/supplychain/demandtopartusedby.csv";
...
** Configuration
  ...
  | Param  | Value                      | Notes                                              |
  |--------+----------------------------+----------------------------------------------------|
  | TRAMP  | /kube:poodle@tigergraph-0: |                                                    |
  | subdir | mydata/                    | Subdir under DataRoot, typically ~/tigergraph/data |


  #+begin_src emacs-lisp :var uri=xfer-params[2,1]
    (message uri)
    (cd uri)
...
** Copy it all by evaluating this Elisp code block
  ...
  creating subdirs as necessary
  #+begin_src emacs-lisp :var uri=xfer-params[2,1] :var dataroot=data-root  :var subdir=xfer-params[3,1] :results value replace
