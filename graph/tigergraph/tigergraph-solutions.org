...
* Principles to follow using this framework
  ...
  + Deploy for data loading to =mydata= directory, located directly under =DataRoot=
...
*** data loading
     #+begin_src sql :tangle solutions/custexp/02-load-data.gsql
       ...
       CREATE LOADING JOB load_job_custexp FOR GRAPH CustExp {
         DEFINE FILENAME Lead="m1:/home/tigergraph/tigergraph/data/mydata/custexp/data/Lead.csv";
         DEFINE FILENAME OpportunityContactRole="m1:/home/tigergraph/tigergraph/data/mydata/custexp/data/OpportunityContactRole.csv";
         DEFINE FILENAME Campaign="m1:/home/tigergraph/tigergraph/data/mydata/custexp/data/Campaign.csv";
         DEFINE FILENAME CampaignMember="m1:/home/tigergraph/tigergraph/data/mydata/custexp/data/CampaignMember.csv";
         DEFINE FILENAME Opportunity="m1:/home/tigergraph/tigergraph/data/mydata/custexp/data/Opportunity.csv";
         DEFINE FILENAME Account="m1:/home/tigergraph/tigergraph/data/mydata/custexp/data/Account.csv";
         DEFINE FILENAME Contact="m1:/home/tigergraph/tigergraph/data/mydata/custexp/data/Contact.csv";
...
*** Load data
    #+begin_src sql :tangle solutions/crunchbase/02-load-data.gsql :mkdirp yes
      ...
      CREATE LOADING JOB load_crunchbase {
        DEFINE FILENAME cb_acquisitions = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_acquisitions.csv";
        DEFINE FILENAME cb_company = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_company.csv";
        DEFINE FILENAME cb_company_milestones = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_company_milestones.csv";
        DEFINE FILENAME cb_company_offices = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_company_offices.csv";
        DEFINE FILENAME cb_degrees = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_degrees.csv";
        DEFINE FILENAME cb_financialorg = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_financialorg.csv";
        DEFINE FILENAME cb_financialorg_milestones = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_financialorg_milestones.csv";
        DEFINE FILENAME cb_fOrg_offices = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_fOrg_offices.csv";
        DEFINE FILENAME cb_funding_rounds = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_funding_rounds.csv";
        DEFINE FILENAME cb_funds = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_funds.csv";
        DEFINE FILENAME cb_invested_by_company = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_invested_by_company.csv";
        DEFINE FILENAME cb_invested_by_fOrg = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_invested_by_fOrg.csv";
        DEFINE FILENAME cb_invested_by_person = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_invested_by_person.csv";
        DEFINE FILENAME cb_ipos = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_ipos.csv";
        DEFINE FILENAME cb_milestones = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_milestones.csv";
        DEFINE FILENAME cb_offices = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_offices.csv";
        DEFINE FILENAME cb_people = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_people.csv";
        DEFINE FILENAME cb_person = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_person.csv";
        DEFINE FILENAME cb_person_milestones = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_person_milestones.csv";
        DEFINE FILENAME cb_personwithcompany = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_personwithcompany.csv";
        DEFINE FILENAME cb_personwithfOrg = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_personwithfOrg.csv";
        DEFINE FILENAME cb_product = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_product.csv";
        DEFINE FILENAME cb_product_milestones = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/cb_product_milestones.csv";
        DEFINE FILENAME degrees = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/degrees.csv";
        DEFINE FILENAME university = "m1:/home/tigergraph/tigergraph/data/mydata/crunchbase/data/university.csv";
...
*** Load data
    #+begin_src sql :tangle solutions/enterprise/02-load-data.gsql :mkdirp yes
      ...
      CREATE LOADING JOB load_enterprise_knowledge FOR GRAPH EnterpriseGraph {
        DEFINE FILENAME enterprise  = "m1:/home/tigergraph/tigergraph/data/mydata/enterprise/data/enterprise.csv";
        DEFINE FILENAME working  = "m1:/home/tigergraph/tigergraph/data/mydata/enterprise/data/working.csv";
        DEFINE FILENAME person_invest_enterprise  = "m1:/home/tigergraph/tigergraph/data/mydata/enterprise/data/person_invest_enterprise.csv";
        DEFINE FILENAME enterprise_invest_enterprise  = "m1:/home/tigergraph/tigergraph/data/mydata/enterprise/data/enterprise_invest_enterprise.csv";
        DEFINE FILENAME enterprise_bid_for_project  = "m1:/home/tigergraph/tigergraph/data/mydata/enterprise/data/enterprise_bid_for_project.csv";
...
*** Load the data
    #+begin_src sql :tangle solutions/ldbc-social/02-load-data.gsql :mkdirp yes
      ...
      CREATE LOADING JOB load_ldbc_snb FOR GRAPH ldbc_snb {
        DEFINE FILENAME v_person_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/person_0_0.csv";
        DEFINE FILENAME v_post_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/post_0_0.csv";
        DEFINE FILENAME v_tag_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/tag_0_0.csv";
        DEFINE FILENAME v_place_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/place_0_0.csv";
        DEFINE FILENAME v_comment_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/comment_0_0.csv";
        DEFINE FILENAME v_forum_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/forum_0_0.csv";
        DEFINE FILENAME v_organisation_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/organisation_0_0.csv";
        DEFINE FILENAME v_tagclass_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/tagclass_0_0.csv";
        DEFINE FILENAME person_knows_person_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/person_knows_person_0_0.csv";
        DEFINE FILENAME comment_replyOf_post_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/comment_replyOf_post_0_0.csv";
        DEFINE FILENAME comment_replyOf_comment_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/comment_replyOf_comment_0_0.csv";
        DEFINE FILENAME post_hasCreator_person_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/post_hasCreator_person_0_0.csv";
        DEFINE FILENAME post_hasTag_tag_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/post_hasTag_tag_0_0.csv";
        DEFINE FILENAME comment_hasCreator_person_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/comment_hasCreator_person_0_0.csv";
        DEFINE FILENAME post_isLocatedIn_place_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/post_isLocatedIn_place_0_0.csv";
        DEFINE FILENAME comment_hasTag_tag_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/comment_hasTag_tag_0_0.csv";
        DEFINE FILENAME comment_isLocatedIn_place_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/comment_isLocatedIn_place_0_0.csv";
        DEFINE FILENAME forum_containerOf_post_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/forum_containerOf_post_0_0.csv";
        DEFINE FILENAME forum_hasMember_person_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/forum_hasMember_person_0_0.csv";
        DEFINE FILENAME forum_hasModerator_person_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/forum_hasModerator_person_0_0.csv";
        DEFINE FILENAME forum_hasTag_tag_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/forum_hasTag_tag_0_0.csv";
        DEFINE FILENAME organisation_isLocatedIn_place_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/organisation_isLocatedIn_place_0_0.csv";
        DEFINE FILENAME person_hasInterest_tag_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/person_hasInterest_tag_0_0.csv";
        DEFINE FILENAME person_isLocatedIn_place_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/person_isLocatedIn_place_0_0.csv";
        DEFINE FILENAME person_likes_comment_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/person_likes_comment_0_0.csv";
        DEFINE FILENAME person_likes_post_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/person_likes_post_0_0.csv";
        DEFINE FILENAME person_studyAt_organisation_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/person_studyAt_organisation_0_0.csv";
        DEFINE FILENAME person_workAt_organisation_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/person_workAt_organisation_0_0.csv";
        DEFINE FILENAME place_isPartOf_place_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/place_isPartOf_place_0_0.csv";
        DEFINE FILENAME tag_hasType_tagclass_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/tag_hasType_tagclass_0_0.csv";
        DEFINE FILENAME tagclass_isSubclassOf_tagclass_file="m1:/home/tigergraph/tigergraph/data/mydata/ldbc-social/data/tagclass_isSubclassOf_tagclass_0_0.csv";
...
*** Load data
    #+begin_src sql :tangle solutions/northwind/02-load-data.gsql :mkdirp yes
      ...
      CREATE LOADING JOB load_all_north {
        DEFINE FILENAME categories="m1:/home/tigergraph/tigergraph/data/mydata/northwind/data/categories.csv";
        DEFINE FILENAME customers="m1:/home/tigergraph/tigergraph/data/mydata/northwind/data/customers.csv";
        DEFINE FILENAME employees="m1:/home/tigergraph/tigergraph/data/mydata/northwind/data/employees.csv";
        DEFINE FILENAME employee_territories="m1:/home/tigergraph/tigergraph/data/mydata/northwind/data/employee-territories.csv";
        DEFINE FILENAME order_details="m1:/home/tigergraph/tigergraph/data/mydata/northwind/data/order-details.csv";
        DEFINE FILENAME orders="m1:/home/tigergraph/tigergraph/data/mydata/northwind/data/orders.csv";
        DEFINE FILENAME products="m1:/home/tigergraph/tigergraph/data/mydata/northwind/data/products.csv";
        DEFINE FILENAME referrals="m1:/home/tigergraph/tigergraph/data/mydata/northwind/data/referrals.csv";
        DEFINE FILENAME regions="m1:/home/tigergraph/tigergraph/data/mydata/northwind/data/regions.csv";
        DEFINE FILENAME suppliers="m1:/home/tigergraph/tigergraph/data/mydata/northwind/data/suppliers.csv";
        DEFINE FILENAME territories="m1:/home/tigergraph/tigergraph/data/mydata/northwind/data/territories.csv";
...
** Copy it all by evaluating this Elisp code block
  ...
  #+RESULTS:
  : Copied solutions to /kube:poodle@tigergraph-0:/home/tigergraph/tigergraph/data/mydata/
