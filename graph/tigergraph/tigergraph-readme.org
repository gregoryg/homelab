...
#+options: todo:t |:t
#+title: TigerGraph how-tos and solution sets
#+date: <2021-11-16 Tue>
...
*** Graph creation
     ...
     #+begin_src sql :tangle staging/custexp/custexp-graph.gsql :mkdirp yes
    ...
    #+end_src
     #+begin_src bash :tangle staging/custexp/01-create-graph.sh
       gsql custexp-graph.gsql
       gsql -g CustExp run schema_change job custexp_schema
     #+end_src

*** data loading
     #+begin_src sql :tangle staging/custexp/loading-job.gsql
       CREATE LOADING JOB load_job_custexp FOR GRAPH CustExp {
         DEFINE FILENAME Lead="/home/tigergraph/mydata/custexp/Lead.csv";
         DEFINE FILENAME OpportunityContactRole="/home/tigergraph/mydata/custexp/OpportunityContactRole.csv";
         DEFINE FILENAME Campaign="/home/tigergraph/mydata/custexp/Campaign.csv";
         DEFINE FILENAME CampaignMember="/home/tigergraph/mydata/custexp/CampaignMember.csv";
         DEFINE FILENAME Opportunity="/home/tigergraph/mydata/custexp/Opportunity.csv";
         DEFINE FILENAME Account="/home/tigergraph/mydata/custexp/Account.csv";
         DEFINE FILENAME Contact="/home/tigergraph/mydata/custexp/Contact.csv";
    ...
    #+begin_src bash :tangle staging/custexp/02-load-data.sh
      gsql -g CustExp loading-job.gsql
      gsql -g CustExp 'run loading job load_job_custexp'
    #+end_src
*** Queries
      #+begin_src sql :tangle staging/custexp/queries.gsql
        ...
        CREATE QUERY CustJourney_Subgraph(vertex<Contact> customer, vertex<Opportunity> opportunity) FOR GRAPH CustExp {
        /*
          Sample input:
              Contact: Sam-Eisenberg
     ...
     #+end_src
     #+begin_src bash :tangle staging/custexp/03-create-queries.sh
       gsql -g CustExp queries.gsql
     #+end_src
*** runall script
     #+begin_src bash :tangle staging/custexp/runall.sh
       ./01-create-graph.sh
       ./02-load-data.sh
...
** STARTED Supply Chain
   ...
   + Resources
     ...
     + GraphStudio export of TGCloud graph: [[file:/data/data-files/graph-data/cust-360/cust-attribution.tar.gz]]
   + Graph creation
     #+begin_src sql :tangle staging/supplychain/supplychain-graph.gsql :mkdirp yes
     ...
     #+end_src
     #+begin_src bash :tangle staging/supplychain/01-create-graph.sh
       gsql supplychain-graph.gsql
       gsql -g SupplyChain run schema_change job custexp_schema
     #+end_src
   + Load data
     #+begin_src sql :tangle staging/supplychain/loading-job.gsql
     ...
     #+end_src
     #+begin_src bash :tangle staging/supplychain/02-load-data.sh
       gsql -g SupplyChain loading-job.gsql
       gsql -g SupplyChain 'run loading job load_job_supplychain'
     #+end_src
   + Queries
     #+begin_src sql :tangle staging/supplychain/queries.gsql
       set exit_on_error = "true"
     ...
     #+end_src
     #+begin_src bash :tangle staging/supplychain/03-create-queries.sh
       gsql -g SupplyChain queries.gsql
     #+end_src
   + Do eet
     #+begin_src bash :tangle staging/supplychain/runall.sh
       ./01-create-graph.sh
       ./02-load-data.sh
       ./03-create-queries.sh
     #+end_src
...
*** Get the data
    ...
    #+end_src
*** Create the schema
    #+begin_src sql :tangle staging/ldbc-social/01-create-graph.gsql :mkdirp yes
...
*** Load the data
    #+begin_src sql :tangle staging/ldbc-social/02-load-data.gsql :mkdirp yes
      USE GRAPH ldbc_snb
