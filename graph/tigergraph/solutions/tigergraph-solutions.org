...
* Principles to follow using this framework
  ...
  + Deploy for data loading to =mydata= directory, located directly under =AppRoot=
...
*** Graph creation
     ...
     #+begin_src sql :tangle custexp/01-create-graph.gsql :mkdirp yes
       USE GLOBAL
       DROP GRAPH CustExp
    ...
    #+end_src
*** data loading
     #+begin_src sql :tangle custexp/02-load-data.gsql
       use graph CustExp
...
*** Queries
      #+begin_src sql :tangle custexp/03-create-queries.gsql
        USE GRAPH CustExp
...
*** Load data
    ...
    #+end_src
*** Add queries
    #+begin_src sql :tangle ldbc-social/03-create-queries.gsql
    #+end_src
...
*** Resources
     ...
     + GraphStudio export of TGCloud graph: [[file:/data/data-files/graph-data/cust-360/cust-attribution.tar.gz]]
*** Graph creation
     #+begin_src sql :tangle supplychain/01-create-graph.gsql :mkdirp yes
       USE GLOBAL
     ...
     #+end_src
*** Load data
    #+begin_src sql :tangle supplychain/02-load-data.gsql
