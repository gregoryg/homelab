...
** Cow me, baby
   ...
   #+begin_src bash :shebang #!/usr/bin/env bash :tangle ~/bin/cowme :results replace output
     ...
     if [ -z ${mycow} ] ; then
         IFS=',' read -r -a safe_cows <<< 'default,default,default,default,bud-frogs,chameleon,small,three-eyes,tux,rancher,rancher-trademarked,kitten,robotfindskitten,owl'
