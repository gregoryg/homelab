...
**** Bash script
     TODO: GET RID OF THIS SHELL SCRIPT - it is deprecated in favor of the python script
    #+begin_src bash :results verbatim :tangle /tmp/yt-audio.sh
...
**** Python code
     ...
     +
     #+begin_src python :tangle scripts/yt-audio.py
       #!/usr/bin/env python3
       import os
       import subprocess
       import json
