...
***** Tests for chaptered and unchaptered video
...
** Find the dang printer
  ...
  #+begin_src bash
    sudo apt -y install cups cups-bsd cups-filters system-config-printer
    sudo lpinfo -v -l
...
** Set printer to print pages in reverse order
  #+begin_src bash
    ...
    sudo lpadmin -p HP-HP-OfficeJet-Pro-8030-series -o outputorder-default=reverse
  #+end_src
